...
class Fb_enhanced {
	...
	function fb_is_liked() {
		...
		if ($request['page']['liked'] || $request->page->liked)
			return true;
		else
			return false;
	}
	...
	public function fb_post_to_feed_dialog($display, $link, $picture, $name, $caption, $description) {
		 ...
		 */
		$tofeed = "<script> 
		FB.init({appId: '" . $this->facebook->getAppId() . "', status: true, cookie: true});
		function postToFeed() {
			var obj = {
			method: 'feed',
	...
	public function fb_request_dialog($display, $name) {
		 ...
		 */
		$send = "<script>
			FB.init({appId: '" . $this->facebook->getAppId() . "', frictionlessRequests: true,});
	...
	public function fb_send_dialog($display, $link, $picture, $name, $to, $description) {
		 ...
		 */
		$send = "<script>
			FB.init({appId: '" . $this->facebook->getAppId() . "', xfbml: true, cookie: true});
