 ...
 */
class core_facebook extends Module
{
     ...
     *
     * @return mixed
     * @throws core_facebook_exception
     */
    public function __call($method, $params)
    {
        if (method_exists($this->facebook, $method)) {
            try {
                ...
                throw new core_facebook_exception("Error trying {$method}(): " . $e->getMessage(), $e, $this->globals['fb_logexcept']);
            }
        } else {
            throw new core_facebook_exception("Could not find the method {$method} in Facebook Class.", null, null, $this->globals['fb_logexcept']);
        }
        ...
        foreach ($request_ids as $value) {
            ...
            if ($request_data['from']) {
                ...
                try {
                    ...
                    throw new core_facebook_exception($e->getMessage(), $e, $this->globals['fb_logexcept']);
                }
                if ($result) {
    ...
    public function fb_check_permissions($perm, $extend = null)
    {
        ...
        } catch (core_facebook_exception $e) {
            throw new core_facebook_exception('fb_fql() : ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_create_event($fb_event_array, $callback = null)
    {
        ...
        try {
            ...
            throw new core_facebook_exception('fb_create_event() - Facebook::api() exception caught: ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_feed($method, $id = null, $values = null)
    {
        ...
        if ($method == 'post') {
            try {
                ...
                throw new core_facebook_exception('fb_feed() - Facebook::api() exception caught: ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
            }
            if (!preg_match('/^[0-9_]+$/', $response)) {
                throw new core_facebook_exception('fb_feed() - Facebook::api() returned an invalid value.', null, $this->globals['fb_logexcept']);
            }
    ...
    public function fb_fql($fqlquery)
    {
        ...
        try {
            ...
            throw new core_facebook_exception('fb_fql() - Facebook::api() exception caught: ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_get_me($redirect = false, $script = true)
    {
        if ($this->userid != null) {
            try {
                ...
                $this->userid = null;
                throw new core_facebook_exception('fb_get_me(): ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
            }
    ...
    public function fb_is_bookmarked()
    {
        try {
            ...
            throw new core_facebook_exception('fb_is_bookmarked(): ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
        if ($datas) {
            return true;
        } else {
    ...
    public function fb_is_liked()
    {
        try {
            ...
            throw new core_facebook_exception('fb_is_liked() - exception caught: ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_list_friends($value = 'uid', $list = '')
    {
        ...
        try {
            ...
            throw new core_facebook_exception('fb_list_friends(): ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_notification($message, $user_id = null)
    {
        ...
        try {
            ...
            throw new core_facebook_exception('fb_notification() - exception caught: ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
        }
    ...
    public function fb_process_credits()
    {
        ...
        if ($request == null) {
            throw new core_facebook_exception('Bad signed request in fb_process_credits()', null, $this->globals['fb_logexcept']);
        }
