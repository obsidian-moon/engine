 ...
 */
class Core_FacebookIgnited extends AbstractModule
{
    ...
    public function __call($method, $params)
    {
        if (method_exists($this->facebook, $method)) {
            try {
                $value = $this->wrapCallUserFuncArray($this->facebook, $method, $params);
     ...
     * @throws FacebookIgnitedException
     */
    public function acceptRequests($request_ids, $callback = false)
    {
        ...
        if (is_array($callback)) {
            ...
            if (isset($this->core->$file)) {
                $this->core->$file->$method($request_ids);
            }
        }
    ...
    public function createEvent($fb_event_array, $callback = null)
    {
        ...
        try {
            ...
            throw new FacebookIgnitedException(
                'createEvent() - Facebook::api() exception caught: ' . $e->getMessage(),
                $e,
                $this->globals['fb_logexcept']
            );
        }
    ...
    public function me($redirect = false, $script = true)
    {
        if ($this->userid != null) {
            try {
                ...
                $this->userid = null;
                throw new FacebookIgnitedException('me(): ' . $e->getMessage(), $e, $this->globals['fb_logexcept']);
            }
